...
static void ng_init_port(struct rte_mempool *mbuf_pool) {
    ...
    txq_conf.offloads = port_conf.rxmode.offloads;
     //ע�⣬������������������⣬nb_tx_desc(=128), should be: <= 4096, >= 512,���а�����������[512, 4096]
    if(rte_eth_tx_queue_setup(gDpdkPortId, 0, 512,
        rte_eth_dev_socket_id(gDpdkPortId), &txq_conf) < 0){//����?����У����а�������socketID�����ð�����ܷ�����?
...
static int ng_encode_icmp(uint8_t * msg, uint8_t * dst_mac, uint32_t sip, uint32_t dip, uint16_t id, uint16_t seqnum){
    ...
    icmp_hdr->icmp_cksum = ng_checksum((uint16_t *)icmp_hdr, sizeof(struct rte_icmp_hdr));//����Ϊɶ����htons
    return 0;
}
            ...
            if(ehdr->ether_type == rte_cpu_to_be_16(RTE_ETHER_TYPE_ARP)){
                ...
                if(arphdr->arp_data.arp_tip == gLocalIp){ 
                    ...
                    if(arphdr->arp_opcode == rte_cpu_to_be_16(RTE_ARP_OP_REQUEST)){
                        ...
                        if(hwaddr == NULL){
                            struct arp_table * table = arp_table_instace();
