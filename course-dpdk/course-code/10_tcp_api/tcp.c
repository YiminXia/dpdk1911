...
static ng_tcp_stream *get_accept_tcb(uint16_t dport) {
...
static ng_tcp_handle_close_wait(struct ng_tcp_stream *stream, struct rte_tcp_hdr *tcphdr, int tcplen)
{
    if(tcphdr->tcp_flags & RTE_TCP_FIN_FLAG) {
